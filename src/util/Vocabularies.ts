...
export const DOGM_NAMESPACE = 'https://dogm.com/ontologies/core/';
export const DOGM = createNamespace(DOGM_NAMESPACE, [
  'Verb',
  'Noun',
  'Mapping',
  'Parameters',
...
export const DOGM_ENGINE_NAMESPACE = 'https://dogm.com/ontologies/dogm-engine/';
export const DOGM_ENGINE = createNamespace(DOGM_ENGINE_NAMESPACE, [
  'update',
  'findAll',
  'findAllBy',
  'find',
